...
class Stocker_Home:
    def __init__(self, top=None):
        ...
        self.Button1.configure(background="#b5bbd8")
        self.Button1.configure(borderwidth="1")
        self.Button1.configure(command=Stocker_Home_support.stocker_change_password)
        ...
        self.Button1_1.configure(background="#b5bbd8")
        self.Button1_1.configure(borderwidth="1")
        self.Button1_1.configure(command=Stocker_Home_support.stocker_add_product)
        ...
        self.Button1_2.configure(background="#b5bbd8")
        self.Button1_2.configure(borderwidth="1")
        self.Button1_2.configure(command=Stocker_Home_support.stocker_view_product)
        ...
        self.Button1_3.configure(background="#b5bbd8")
        self.Button1_3.configure(borderwidth="1")
        self.Button1_3.configure(command=Stocker_Home_support.stocker_logout)
