...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 597x394+340+137
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra38 \
        -borderwidth 2 -relief groove -background {#b106d3} -height 385 \
    ...
    button $site_3_0.but38 \
        ...
        -background {#b106d3} -disabledforeground {#a3a3a3} \
    ...
    frame $site_3_0.fra39 \
        -relief groove -background {#0a0a0a} -height 385 \
        -highlightbackground {#d9d9d9} -highlightcolor black -width -9 
    ...
    vTcl:DefineAlias "$site_3_0.lab38" "Label3" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab39 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#b106d3} -disabledforeground {#a3a3a3} \
        -font $::vTcl(fonts,vTcl:font10,object) -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text PHONE 
    vTcl:DefineAlias "$site_3_0.lab39" "Label3_1" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab43 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#b106d3} -disabledforeground {#a3a3a3} \
        -font $::vTcl(fonts,vTcl:font10,object) -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text PASSWORD 
    vTcl:DefineAlias "$site_3_0.lab43" "Label3_2" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.but38 \
        -in $site_3_0 -x 70 -y 280 -anchor nw -bordermode ignore 
    place $site_3_0.fra39 \
        -in $site_3_0 -x 300 -y 0 -width -9 -relwidth 0 -height 385 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab40 \
        -in $site_3_0 -x 10 -y 10 -width 284 -relwidth 0 -height 41 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 18 -y 82 -width 64 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 126 -y 80 -width 64 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab38 \
        -in $site_3_0 -x 13 -y 133 -width 74 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab39 \
        -in $site_3_0 -x 16 -y 181 -width 74 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 14 -y 228 -width 114 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 0 -y 5 -width 595 -relwidth 0 -height 385 -relheight 0 \
