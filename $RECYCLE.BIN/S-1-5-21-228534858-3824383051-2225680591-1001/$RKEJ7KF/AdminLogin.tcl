...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 478x332+270+113
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra38 \
        -borderwidth 2 -relief groove -background {#ffca85} -height 315 \
    ...
    vTcl:DefineAlias "$site_3_0.ent41" "admin_username" vTcl:WidgetProc "Toplevel1" 1
    ...
    button $site_3_0.but45 \
        ...
        -background {#ffca85} -borderwidth 0 -command adminLoginValidation \
    ...
    place $site_3_0.lab40 \
        -in $site_3_0 -x 60 -y 102 -width 100 -height 34 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent41 \
        -in $site_3_0 -x 187 -y 104 -width 184 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 60 -y 160 -width 100 -height 34 -anchor nw \
        -bordermode inside 
    place $site_3_0.ent44 \
        -in $site_3_0 -x 189 -y 160 -width 184 -height 30 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 190 -y 220 -width 187 -relwidth 0 -height 34 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 10 -width 455 -relwidth 0 -height 315 -relheight 0 \
