...
import AdminAddProduct_support
...
def vp_start_gui():
    ...
    AdminAddProduct_support.init(root, top)
    root.mainloop()
...
def create_Add_Product(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = Add_Product (w)
    AdminAddProduct_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Add_Product:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.14, rely=0.05, height=41, width=264)
        ...
        self.Label2.place(relx=0.01, rely=0.23, height=31, width=114)
        ...
        self.Label2_1.place(relx=0.03, rely=0.36, height=31, width=84)
        ...
        self.Label2_2.place(relx=0.04, rely=0.52, height=31, width=74)
        ...
        self.Label2_3.place(relx=0.01, rely=0.67, height=31, width=114)
        ...
        self.Label2_3.configure(text='''Quantity''')

        self.P_Number = Entry(self.Frame1)
        self.P_Number.place(relx=0.37, rely=0.23,height=30, relwidth=0.5)
        ...
        self.P_Name.place(relx=0.38, rely=0.37,height=30, relwidth=0.5)
        ...
        self.P_Price.place(relx=0.38, rely=0.51,height=30, relwidth=0.5)
        ...
        self.P_Quantity.place(relx=0.38, rely=0.67,height=30, relwidth=0.5)
        ...
        self.Button1.place(relx=0.38, rely=0.81, height=34, width=67)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#0cf4ae")
        self.Button1.configure(command=AdminAddProduct_support.Add_product_save)
        ...
        self.Button1_1.place(relx=0.7, rely=0.81, height=34, width=67)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#0cf4ae")
        self.Button1_1.configure(command=AdminAddProduct_support.Add_product_Cancel)
