...
proc vTclWindow.top37 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -background {#0cf4ae} -highlightbackground {#d9d9d9} \
        -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 411x332+320+117
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "DispatcherLogin "
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 10 -relief groove -background {#0cf4ae} -height 325 \
    ...
    vTcl:DefineAlias "$site_3_0.ent41" "Dispatcher_name" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.ent42" "Dispatcher_password" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but43 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#0cf4ae} -borderwidth 0 -command Dispatcher_login \
    ...
    place $site_3_0.lab39 \
        -in $site_3_0 -x 49 -y 110 -width 112 -relwidth 0 -height 64 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab40 \
        -in $site_3_0 -x 59 -y 165 -width 115 -relwidth 0 -height 64 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent41 \
        -in $site_3_0 -x 197 -y 126 -width 164 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent42 \
        -in $site_3_0 -x 199 -y 182 -width 164 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but43 \
        -in $site_3_0 -x 250 -y 240 -width 76 -relwidth 0 -height 43 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab44 \
        -in $site_3_0 -x 82 -y 30 -width 223 -height 43 -anchor nw \
        -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 4 -y 5 -width 405 -relwidth 0 -height 325 -relheight 0 \
