...
class Admin_Login:
    def __init__(self, top=None):
        ...
        font10 = "-family {Segoe UI} -size 21 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font11 = "-family {Segoe UI} -size 16 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font9 = "-family {Courier New} -size 13 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"

        top.geometry("461x317+398+162")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#291284")
        ...
        self.Label1.configure(background="#291284")
        ...
        self.Label2.configure(background="#291284")
        ...
        self.Admin_paas.configure(background="#291284")
        self.Admin_paas.configure(disabledforeground="#a3a3a3")
        self.Admin_paas.configure(font=font11)
        ...
        self.Admin_paas.configure(text='''Password''')
        ...
        self.Admin_Button.configure(background="#291284")
        self.Admin_Button.configure(borderwidth="0")
        self.Admin_Button.configure(command=Admin_support.Admin_validation)
        self.Admin_Button.configure(disabledforeground="#a3a3a3")
        self.Admin_Button.configure(font=font11)
        ...
        self.Admin_Button_1.configure(background="#291284")
        self.Admin_Button_1.configure(borderwidth="0")
        self.Admin_Button_1.configure(command=Admin_support.Admin_Cancel)
        self.Admin_Button_1.configure(disabledforeground="#a3a3a3")
        self.Admin_Button_1.configure(font=font11)
