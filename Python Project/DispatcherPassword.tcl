...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 463x450+417+135
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra38 \
        -borderwidth 2 -relief groove -background {#b6afd8} -height 445 \
    ...
    label $site_3_0.lab39 \
        ...
        -background {#b6afd8} -disabledforeground {#a3a3a3} \
        -font $::vTcl(fonts,vTcl:font10,object) -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -text {Dipatcher Password} 
    ...
    vTcl:DefineAlias "$site_3_0.ent43" "Old_Pass" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent44 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent44" "New_Pass" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent45 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent45" "Retype_Pass" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but46 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#b6afd8} -borderwidth 7 -command Change_Paas \
    ...
    place $site_3_0.lab39 \
        -in $site_3_0 -x 81 -y 33 -width 254 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab40 \
        -in $site_3_0 -x 10 -y 127 -width 164 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 7 -y 199 -width 164 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 10 -y 270 -width 134 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent43 \
        -in $site_3_0 -x 197 -y 127 -width 214 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent44 \
        -in $site_3_0 -x 197 -y 199 -width 214 -height 30 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent45 \
        -in $site_3_0 -x 196 -y 270 -width 214 -height 30 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 250 -y 340 -width 107 -relwidth 0 -height 44 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x -1 -y 3 -width 455 -relwidth 0 -height 445 -relheight 0 \
