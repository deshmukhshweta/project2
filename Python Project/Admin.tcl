...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 461x317+398+162
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra38 \
        -borderwidth 14 -relief groove -background {#291284} -height 315 \
    ...
    label $site_3_0.lab39 \
        ...
        -background {#291284} -disabledforeground {#a3a3a3} \
    ...
    button $site_3_0.but45 \
        ...
        -background {#291284} -borderwidth 0 -command Admin_validation \
    ...
    button $site_3_0.but38 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#291284} -borderwidth 0 -command Admin_Cancel \
        -disabledforeground {#a3a3a3} -font $::vTcl(fonts,vTcl:font11,object) \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
    ...
    ###################
    place $top.fra38 \
        -in $top -x 1 -y 1 -width 465 -relwidth 0 -height 315 -relheight 0 \
