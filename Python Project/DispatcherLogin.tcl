...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 416x362+402+131
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Dispatcher Login"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 15 -relief groove -background {#d8cd36} -height 365 \
        -highlightbackground {#d9d9d9} -highlightcolor black -width 415 
    vTcl:DefineAlias "$top.fra38" "Frame1" vTcl:WidgetProc "Toplevel1" 1
    set site_3_0 $top.fra38
    label $site_3_0.lab39 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d8cd36} -borderwidth 4 -disabledforeground {#a3a3a3} \
    ...
    label $site_3_0.lab41 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d8cd36} -disabledforeground {#a3a3a3} \
        -font $::vTcl(fonts,vTcl:font9,object) -foreground {#000000} \
    ...
    vTcl:DefineAlias "$site_3_0.ent43" "Dispatcher_username" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent44 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black -show * 
    vTcl:DefineAlias "$site_3_0.ent44" "Dispatcher_password" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but45 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d8cd36} -command dispatcher_login \
    ...
    place $site_3_0.lab39 \
        -in $site_3_0 -x 40 -y 30 -width 314 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 26 -y 110 -width 84 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 27 -y 160 -width 84 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent43 \
        -in $site_3_0 -x 158 -y 110 -width 164 -relwidth 0 -height 30 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent44 \
        -in $site_3_0 -x 158 -y 161 -width 164 -height 30 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but45 \
        -in $site_3_0 -x 199 -y 228 -width 77 -relwidth 0 -height 34 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x -2 -y -1 -width 415 -relwidth 0 -height 365 -relheight 0 \
