...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        self.Button1.place(relx=0.07, rely=0.24, height=34, width=237)
        ...
        self.Button1_1.configure(text='''View Stock''')
        ...
        self.Button1_2.configure(text='''View Order's''')

        self.Button1_3 = Button(self.Frame1)
        self.Button1_3.place(relx=0.09, rely=0.89, height=34, width=237)
        ...
        self.Button1_1 = Button(self.Frame1)
        self.Button1_1.place(relx=0.09, rely=0.73, height=34, width=237)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#b28cd8")
        self.Button1_1.configure(borderwidth="1")
        self.Button1_1.configure(command=DispatcherHome_support.dispatcher_view_product)
        self.Button1_1.configure(disabledforeground="#a3a3a3")
        self.Button1_1.configure(font=font9)
        self.Button1_1.configure(foreground="#000000")
        self.Button1_1.configure(highlightbackground="#d9d9d9")
        self.Button1_1.configure(highlightcolor="black")
        self.Button1_1.configure(pady="0")
        self.Button1_1.configure(text='''Sent Order''')
